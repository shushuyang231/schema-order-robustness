...
The disjoint decomposed studies then reproduced nonzero representation effects across four text-mode deployments (Table 3). Every one of the eight intervals has a positive lower bound. \textbf{Answer to RQ1:} validator-equivalent serialization can change normalized black-box output distributions beyond repeated-prompt variability, but magnitude is system- and deployment-contingent.
